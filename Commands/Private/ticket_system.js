...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("tickets")
    .setDescription("🎫 Crear sistema de tickets (ADMIN)")
  ...
  execute(interaction, client) {
    const embed = new EmbedBuilder()
      ...
      .setColor("#2acaea")
      .setDescription(
        "Bienvenid@ al sistema de tickets. Para cualquier inquietud, duda, solicitud, sugerencia, consulta o reporte abrá un ticket y deja escrita tu petición para responder con más facilidad."
      );
